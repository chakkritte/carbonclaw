...
async def _get_models(provider_name: str, config: CarbonClawConfig) -> list[str]:
    try:
...
def models(
    ...
    console.print(Panel("🤖 [bold blue]CarbonClaw Model Wizard[/bold blue]", border_style="blue"))
