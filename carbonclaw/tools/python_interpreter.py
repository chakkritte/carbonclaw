...
class PythonTool(BaseTool):
    ...
    async def execute(self, arguments: dict[str, Any]) -> ToolResult:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            img_dir = Path(tmpdir)
            for img_file in img_dir.glob("carbonclaw_output_*.png"):
    ...
    def _wrap_code(code: str) -> str:
        ...
        return (
            ...
            "    _orig_show = plt.show\n"
            "    def _carbonclaw_show(*args, **kwargs):\n"
            "        for i, fig in enumerate(plt.get_fignums()):\n"
            "            plt.figure(fig).savefig(f'carbonclaw_output_{i}.png')\n"
            "    plt.show = _carbonclaw_show\n"
            "except ImportError:\n"
            "    pass\n"
            "\n"
            "# Run user code\n"
