...
Exposes external MCP servers as CarbonClaw tools.
"""
...
from carbonclaw.core.models import ToolDefinition, ToolResult

logger = structlog.get_logger()


class MCPTool(BaseTool):
    """Wrap an MCP tool as a CarbonClaw BaseTool.
...
async def register_mcp_tools(registry: ToolRegistry, config: CarbonClawConfig) -> list[MCPClient]:
