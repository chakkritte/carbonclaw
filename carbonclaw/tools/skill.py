...
from carbonclaw.core.base import BaseTool, ToolResult
...
class ActivateSkillTool(BaseTool):
    ...
    def __init__(self, skills_dir: Optional[Path] = None) -> None:
        super().__init__()
        self.skills_dir = skills_dir or Path(platformdirs.user_config_dir("carbonclaw")) / "skills"
    ...
    async def execute(self, arguments: dict[str, Any]) -> ToolResult:
        ...
        project_skill_file = Path.cwd() / ".carbonclaw" / "skills" / f"{name}.md"
